...
public class RopeModule extends LeptonModule {
	...
	public static final Block ROPE = new RopeBlock(FabricBlockSettings.of(Material.WOOL, MaterialColor.BROWN).strength(0.5f, 0.5f).sounds(BlockSoundGroup.WOOL).build());
